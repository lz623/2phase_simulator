...
class MINC;
template< >
class MeshBuilder< MINC>
{
public:
	MeshBuilder(std::size_t NX, std::size_t NY, std::size_t NZ, std::size_t Nc,
	...
	void build(Point &gravity, T1 & mcells, T2 &mfaces, T1 & fcells, T2 ffaces)
	{
